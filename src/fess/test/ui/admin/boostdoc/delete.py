...
def run(playwright: Playwright) -> None:
    ...
    # assert page.url == "http://localhost:8080/admin/boostdoc/"

    # Click text=/.*url\.matches\("https://www\.n2sm\.net/\.\*"\).*/
    page.click("text=/.*url\.matches\(\"https://www\.n2sm\.net/\.\*\"\).*/")
    # assert page.url == "http://localhost:8080/admin/boostdoc/details/4/H5jx8XsBFFIjqpLehsuj"
