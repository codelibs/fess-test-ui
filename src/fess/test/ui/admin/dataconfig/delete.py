...
def run(context: FessContext) -> None:
    ...
    # Get the name from the first row before deletion
    first_row_name = page.inner_text("tbody tr:first-child")
    ...
    try:
        ...
        assert first_row_name not in table_content or "該当するデータがありません" in page.inner_text("body"), \
